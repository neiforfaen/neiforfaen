...
This is what I focused on when I built [kosei](https://github.com/neiforfaen/kosei-cli), a tool now used at [Pleo](https://pleo.io) to switch between environments (`staging | dev`) when developing locally.
